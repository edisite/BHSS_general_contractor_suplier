...
class Supplier extends Admin_Controller {
	...
	public function gcrud(){
		$crud = $this->generate_crud('mitra_supplier');
		$crud->columns('supp_kode','supp_nama','supp_bidang','supp_kota',
					'supp_alamat','supp_create_date');
		$crud->display_as('supp_kode', 'Kode');
		$crud->display_as('supp_nama', 'Nama');
		$crud->display_as('supp_bidang', 'Kategori');
		$crud->display_as('supp_kota', 'Kota');
		$crud->display_as('supp_alamat', 'Alamat');
		$crud->display_as('supp_update_date', 'Update Date');
		$crud->display_as('supp_update_by', ' Update By');
		$crud->display_as('supp_create_date', 'Create Date');
		$crud->display_as('supp_create_by', ' Create By');
		$crud->display_as('supp_provinsi', ' Provinsi');
		$crud->display_as('supp_telp', ' Telp');
		$crud->display_as('supp_email', ' Email');
		$crud->display_as('supp_pic', ' Pic');
		$crud->display_as('supp_pajak', ' Pajak');
		$crud->display_as('supp_npwp_nama', ' Nama NPWP');
		$crud->display_as('supp_npwp_nomor', ' No. NPWP');
		$crud->display_as('supp_bidang', ' Bidang');
