                            ...
                            <div>
                                <div data-repeater-item>
                                    <form class="form row" id="formAdd" >
                                        <input type="hidden" id="url" value="_admin/project/postData_rab">
                                        <input type="hidden" id="url_data" value="_admin/project/rab/">
                                        <input type="hidden" id="project_kode" name="project_kode" value="<?php echo $project_kode; ?>">
                                        ...
                                        <div class="form-group mb-1 col-sm-12 col-md-2">
                                            ...
                                            <br>
                                            <input type="text" class="form-control" id="rab_kode" name="rab_kode" placeholder="" required>
                                        </div>
                                        <div class="form-group mb-1 col-sm-12 col-md-4">
                                            <label for="email-addr">Nama RAB</label>
                                            <br>
                                            <input type="text" class="form-control" id="nama_rab" name="nama_rab" placeholder="Input Nama RAB" required>
                                        </div>
                                        <div class="form-group mb-1 col-sm-12 col-md-2">
                                            <label for="email-addr">Saldo Rencana</label>
                                            <br>
                                            <input type="text" class="form-control" id="saldo_awal" name="saldo_awal" placeholder="Rp" required>
                                        </div>
