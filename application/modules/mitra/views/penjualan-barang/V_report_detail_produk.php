                                ...
                                <div class="form-body">								
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <h4>-</h4>
                                                <div class="input-group">
                                                <button type="submit" class="btn btn-success" onclick='searchMitra_ReportDetailProduk()'>
	        ...
	        <div class="card">
	            <div class="card-content collpase show">
	                <div class="card-body card-dashboard">
                        <table class="table table-striped table-bordered server-side" id="mitraReportPenjualanDetailProduk">
                            <thead>
                                <tr>
                                    <th> No </th>
                                    <th> Tanggal </th>
